        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            {features.map((feature, index) => (
              <motion.div
                key={index}
                className="p-6 bg-gray-900/50 border border-gray-800/50 hover:border-blue-500/50 transition-colors duration-300"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 gap-8">
            {useCases.map((useCase, index) => (
              <motion.div
                key={index}
                className="p-8 bg-gray-900/50 border border-gray-800/50 hover:border-blue-500/50 transition-colors duration-300"
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                transition={{ delay: index * 0.1 }}
              >
      ...
      >
        <div className="max-w-4xl mx-auto text-center">
          <p className="text-xl text-gray-300 leading-relaxed mb-8">
            Ready to transform your business with our {title.toLowerCase()} solutions?
          </p>
          <a 
            href="/contact" 
