...
const NavLink = ({ 
  ...
  return (
    <button
      ...
      className="px-3 py-1 text-sm text-gold hover:text-gold transition-colors duration-200 bg-gray-800 hover:bg-blue-500/20 hover:text-gold transition-colors duration-200"
    >
      {children}
    </button>
  )
