...
export default function Navbar() {
  ...
  const Links = ['Home', 'Platforms', 'Solutions', 'Statistics', 'Demos', 'Pricing', 'About', 'Contact', 'Login', 'Admin']
  const paths = ['/', '#', '#', '/statistics', '/demos', '/pricing', '/about', '/contact', 'https://aiui.com.au', '/admin']
